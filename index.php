        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              if(isset($_SESSION['username'])){
                ...
                echo '<a href="" class="nav-item nav-link">' . $_SESSION["comp_id"] . '</a>';
                ...
                <a href="contact.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Post A Job<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
            ...
            <div class="container">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
                                        ...
                                        $expireTimestamp = strtotime($row['expire_date']);
                                         ...
                                         if($expireTimestamp < $currentTimestamp){
                                            ...
                                            <div class="d-flex mb-3">
                                                <a class="btn btn-primary disabled" href="">Apply Now</a>
                                            </div>';
                                         }
                                         else{
                                            echo '<div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                        ...
                        <?php
                                $stmt = $pdo->prepare("SELECT * FROM jobs WHERE id = :comp_id");
