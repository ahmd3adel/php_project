                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="job_title" class="form-control" id="name" placeholder="job title">
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="subject">expire date</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-floating">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="subject" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
